...
class Registry:
    ...
    def register_task(cls, name: str):
        ...
        Usage::
            from prisma.backbones.common.registry import registry
            from prisma.backbones.tasks import BaseTask
    ...
    def register_dataset(cls, name: str):
        ...
        Usage::
            ...
            from prisma.backbones.common.registry import registry
            from prisma.backbones.datasets import BaseDataset
    ...
    def register_model(cls, name: str):
        ...
        Usage::
            ...
            from prisma.backbones.common.registry import registry
            from prisma.backbones.modules.layers import CGCNNConv
    ...
    def register_logger(cls, name: str):
        ...
        def wrap(func: Callable[..., R]) -> Callable[..., R]:
            from prisma.backbones.common.logger import Logger
