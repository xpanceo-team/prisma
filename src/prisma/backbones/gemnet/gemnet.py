...
from prisma.backbones.base import BackboneInterface, GraphModelMixin, HeadInterface
from prisma.backbones.modules.scaling.compat import load_scales_compat
